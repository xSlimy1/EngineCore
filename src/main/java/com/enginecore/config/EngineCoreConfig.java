...
public final class EngineCoreConfig {
    ...
    public static final ForgeConfigSpec.BooleanValue ENABLE_AI_THROTTLE;
    public static final ForgeConfigSpec.BooleanValue ENABLE_GC_OPTIMIZER;
    public static final ForgeConfigSpec.BooleanValue ENABLE_REDSTONE_BATCHING;
    public static final ForgeConfigSpec.BooleanValue ENABLE_ITEM_MERGE_OPTIMIZER;
    public static final ForgeConfigSpec.BooleanValue ENABLE_ANIMAL_OPTIMIZER;
    public static final ForgeConfigSpec.BooleanValue ENABLE_LIGHT_DAMPENER;

    public static final ForgeConfigSpec.DoubleValue AI_NEAR_DISTANCE;
    public static final ForgeConfigSpec.DoubleValue AI_MID_DISTANCE;
    public static final ForgeConfigSpec.DoubleValue AI_FAR_DISTANCE;
    public static final ForgeConfigSpec.IntValue AI_MID_SKIP_INTERVAL;
    public static final ForgeConfigSpec.IntValue AI_FAR_SKIP_INTERVAL;
    public static final ForgeConfigSpec.IntValue AI_VERY_FAR_SKIP_INTERVAL;
    public static final ForgeConfigSpec.BooleanValue AI_EXEMPT_CUSTOM_NAMED;
    public static final ForgeConfigSpec.BooleanValue AI_EXEMPT_VEHICLE_PASSENGERS;
    public static final ForgeConfigSpec.ConfigValue<List<? extends String>> AI_BLACKLIST;

    public static final ForgeConfigSpec.IntValue REDSTONE_MAX_BATCHED_UPDATES;
    public static final ForgeConfigSpec.IntValue MUTABLE_POS_POOL_SIZE;
